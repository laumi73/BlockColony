...
namespace LocalWorld
{
    public partial class Chunk : Node3D
    {
        ...
        public short[,,] blockArray = new short[ChunkResources.CHUNK_WIDTH, ChunkResources.CHUNK_HEIGHT, ChunkResources.CHUNK_WIDTH];
        ...
        private short[,,] PopulateChunk() {
            return new short[ChunkResources.CHUNK_WIDTH, ChunkResources.CHUNK_HEIGHT, ChunkResources.CHUNK_WIDTH];
        }
